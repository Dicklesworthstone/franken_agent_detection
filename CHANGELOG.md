...
|---------|------|------|---------|
| [`v0.3.0`](https://github.com/Dicklesworthstone/franken_agent_detection/releases/tag/v0.3.0) | GitHub Release | 2026-09-15 | Shared Codebuff / Freebuff history, SQLite 0.4.1 and Asupersync 0.5 migration, unwind-safe read transactions, and bounded crate contents. |
